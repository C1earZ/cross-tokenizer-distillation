...
def tokenize(item, tokenizer, encoder_decoder=False):
    """将SQuAD问答数据项转换为模型输入的token序列
    参数:
        item: 数据项，包含title（标题）、context（上下文）、question（问题）、answers_generated（生成的答案）
        tokenizer: 分词器对象
